      ...
      <div className="w-auto">
        <div className="flex flex-wrap items-center">
          <div className="w-auto mr-14">
            <a href="#">
              <img src="flaro-assets/logos/flaro-logo-black.svg" alt=""></img>
            </a>
          </div>
        </div>
      </div>
      <div className="w-auto">
        <div className="flex flex-wrap items-center">
          <div className="w-auto hidden lg:block">
            ...
            <li className="mr-9 font-medium hover:text-gray-700"><a href="/">Home</a></li>
              <li className="mr-9 font-medium hover:text-gray-700"><a href="members">Members Collection</a></li>
              <li className="mr-9 font-medium hover:text-gray-700"><a href="/about">About</a></li>
              <li className="font-medium hover:text-gray-700"><a href="/login">Login</a></li>
            </ul>
          </div>
          <div className="w-auto hidden lg:block">
            <div className="inline-block">
            <a href="/createAccount"><button className="py-3 px-5 w-full text-white font-semibold rounded-xl focus:ring focus:ring-indigo-300 bg-indigo-600 hover:bg-indigo-700 transition ease-in-out duration-200" type="button">Create Account</button></a>
            </div>
          </div>
