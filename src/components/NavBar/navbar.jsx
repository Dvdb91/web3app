        ...
        <div class="flex flex-wrap items-center">
          <div class="w-auto hidden lg:block">
            ...
            <li class="mr-9 font-medium hover:text-gray-700"><a href="/">Home</a></li>
              <li class="mr-9 font-medium hover:text-gray-700"><a href="members">Members Collection</a></li>
              <li class="mr-9 font-medium hover:text-gray-700"><a href="/about">About</a></li>
              <li class="font-medium hover:text-gray-700"><a href="/login">Login</a></li>
            </ul>
          </div>
          <div class="w-auto hidden lg:block">
            <div class="inline-block">
            <a href="/createAccount"><button class="py-3 px-5 w-full text-white font-semibold rounded-xl focus:ring focus:ring-indigo-300 bg-indigo-600 hover:bg-indigo-700 transition ease-in-out duration-200" type="button">Create Account</button></a>
            </div>
          </div>
