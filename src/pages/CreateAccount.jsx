...
return (
  ...
  <img class="absolute left-0 top-0" src="flaro-assets/images/sign-in/gradient.svg" alt=""></img>
          ...
          <div class="w-full">
            <div class="md:max-w-lg mx-auto pt-16 md:pb-32">
              <a class="mb-28 inline-block" href="#">
                <img src="flaro-assets/logos/flaro-logo-black-xl.svg" alt=""></img>
              </a>
      ...
      <div class="p-4 py-16 flex flex-col justify-center bg-blueGray-100 h-full">
        <form class="md:max-w-lg mx-auto">
          <label class="block mb-4">
            ...
            <input class="px-4 py-3.5 w-full text-gray-400 font-medium placeholder-gray-400 bg-white outline-none border border-gray-300 rounded-lg focus:ring focus:ring-indigo-300" id="signInInput1-1" type="text" placeholder="Enter email address"></input>
          </label>
          <label class="block mb-5">
            <p class="mb-2 text-gray-900 font-semibold leading-normal">Password *</p>
            <input class="px-4 py-3.5 w-full text-gray-400 font-medium placeholder-gray-400 bg-white outline-none border border-gray-300 rounded-lg focus:ring focus:ring-indigo-300" id="signInInput1-2" type="password" placeholder="********"></input>
          </label>
          <div class="flex flex-wrap justify-between -m-2 mb-4">
            <div class="w-auto p-2">
              <div class="flex items-center">
                <input class="w-4 h-4" id="default-checkbox" type="checkbox" value=""></input>
          ...
          <div class="flex flex-wrap justify-center -m-2">
            <div class="w-auto p-2">
              <button class="flex items-center p-4 bg-white hover:bg-gray-50 border rounded-lg transition ease-in-out duration-200">
                <img class="mr-3" src="flaro-assets/logos/brands/google.svg" alt=""></img>
                <span class="font-semibold leading-normal">Sign in with Google</span>
              </button>
            </div>
            <div class="w-auto p-2">
              <button class="flex items-center p-4 bg-white hover:bg-gray-50 border rounded-lg transition ease-in-out duration-200">
                <img class="mr-3" src="flaro-assets/logos/brands/fb.svg" alt=""></img>
